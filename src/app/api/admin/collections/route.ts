...
const MISSING_TABLE_HELP = 'Supabase table public.collections is missing. Go to Supabase Dashboard → SQL Editor → run the full supabase/schema.sql file → click Run → refresh this page.';
